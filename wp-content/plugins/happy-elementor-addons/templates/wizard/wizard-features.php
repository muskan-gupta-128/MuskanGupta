...
<legend>{{makeLabel(feature.is_pro)}}</legend>
                    <div class="feature_inner">
                        ...
                        <div class="ha-dashboard-features__item-toggle ha-toggle">
                            <input :id="`ha-feature-${feature.slug}`" type="checkbox" :value="feature.slug" class="ha-toggle__check ha-feature" v-model="feature.is_active" @click="isFeatureActive(feature.slug,feature.is_active)"><b class="ha-toggle__switch"></b>
